...
template <class T> SeriesC<T> C2q2Q2l_qpQmQpqmemep_nf
...
//{{qp, Qm, Qp, qm, em, ep}, nf}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:49:17 on n302"
...
template <class T> SeriesC<T> C2q2Q2l_qpQpQmqmemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, Qp, Qm, qm, em, ep}, nf}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:49:18 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
...
template <class T> SeriesC<T> C2q2Q2l_qmQpQmqpemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, Qp, Qm, qp, em, ep}, nf}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:49:19 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
...
template <class T> SeriesC<T> C2q2Q2l_qmQmQpqpemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
...
template <class T> SeriesC<T> C2q2Q2l_qpQmQpqmemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, Qm, Qp, qm, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:50:30 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
...
template <class T> SeriesC<T> C2q2Q2l_qpQpQmqmemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, Qp, Qm, qm, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:50:37 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spa56 = SPA(5,6);
...
template <class T> SeriesC<T> C2q2Q2l_qmQpQmqpemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, Qp, Qm, qp, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:51:43 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> C2q2Q2l_qmQmQpqpemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, Qm, Qp, qp, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:51:50 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spa24 = SPA(2,4);
...
template <class T> SeriesC<T> C2q2Q2l_qpqmQpQmemep_sl
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, Qp, Qm, em, ep}, sl}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:54:41 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa14 = SPA(1,4);
complex<T> spb13 = SPB(1,3);
...
template <class T> SeriesC<T> C2q2Q2l_qpqmQmQpemep_sl
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, Qm, Qp, em, ep}, sl}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:57:34 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
complex<T> spb23 = SPB(2,3);
...
template <class T> SeriesC<T> C2q2Q2l_qmqpQpQmemep_sl
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, qp, Qp, Qm, em, ep}, sl}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:00:20 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa23 = SPA(2,3);
complex<T> spb13 = SPB(1,3);
...
template <class T> SeriesC<T> C2q2Q2l_qmqpQmQpemep_sl
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, qp, Qm, Qp, em, ep}, sl}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:06 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa23 = SPA(2,3);
complex<T> spb13 = SPB(1,3);
...
template <class T> SeriesC<T> C2q2Q2l_qpqmQpQmemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, Qp, Qm, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:08 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> C2q2Q2l_qmqpQpQmemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, qp, Qp, Qm, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:11 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> C2q2Q2l_qpqmQmQpemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, Qm, Qp, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:13 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa35 = SPA(3,5);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> C2q2Q2l_qmqpQmQpemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qm, qp, Qm, Qp, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:15 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa35 = SPA(3,5);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> ( *C2q2Q2l_AX_Ptr_eval( int hc))
...
template <class T> SeriesC<T> ( *C2q2Q2l_L_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template <class T> SeriesC<T> ( *C2q2Q2l_nf_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template <class T> SeriesC<T> ( *C2q2Q2l_sl_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template SeriesC<R> ( *C2q2Q2l_AX_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2Q2l_AX_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2Q2l_AX_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);


template SeriesC<R> ( *C2q2Q2l_L_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2Q2l_L_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2Q2l_L_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);


template SeriesC<R> ( *C2q2Q2l_nf_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2Q2l_nf_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2Q2l_nf_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);


template SeriesC<R> ( *C2q2Q2l_sl_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2Q2l_sl_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2Q2l_sl_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);
