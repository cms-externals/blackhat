...
template <class T> SeriesC<T> C2q2g2l_qpppqmemep_L
...
//{{qp, p, p, qm, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:49:12 on n302"
...
SeriesC<T> result = co5*(t2*Int(ep,mu,c234,c156) + t10*Int(ep,mu,c34,c1256) + t1*Int(ep,mu,c56,c1234) + co1*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c3,c2,c1,c456) + co3*Int(ep,mu,c4,c23,c1,c56) + co4*Int(ep,mu,c4,c3,c2,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qppmqmemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, p, m, qm, em, ep}, L}
 ...
 // #define TimeStamp "Mon 17 Nov 2008 23:49:39 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa12 = SPA(1,2);
complex<T> spa56 = SPA(5,6);
...
SeriesC<T> result = co7*(t20*Int(ep,mu,c123,c456) + t19*Int(ep,mu,c23,c1456) + t18*Int(ep,mu,c234,c156) + t13*Int(ep,mu,c56,c1234) + t2*Int(ep,mu,c1,c2,c3456) + t4*Int(ep,mu,c1,c23,c456) + co1*Int(ep,mu,c12,c34,c56) + t3*Int(ep,mu,c2,c3,c1456) + t1*Int(ep,mu,c2,c34,c561) + t5*Int(ep,mu,c3,c4,c1256) + co2*Int(ep,mu,c34,c12,c56) + t6*Int(ep,mu,c5,c6,c1234) + co3*Int(ep,mu,c2,c1,c56,c34) + co4*Int(ep,mu,c2,c3,c4,c156) + co5*Int(ep,mu,c3,c2,c1,c456) + co6*Int(ep,mu,c3,c4,c56,c12));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpmpqmemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, p, qm, em, ep}, L}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:02:47 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spa56 = SPA(5,6);
...
SeriesC<T> result = co1*(t1*Int(ep,mu,c12,c3456) + t65*Int(ep,mu,c123,c456) + t62*Int(ep,mu,c23,c1456) + t60*Int(ep,mu,c234,c156) + t3*Int(ep,mu,c34,c1256) + t2*Int(ep,mu,c56,c1234) + t27*Int(ep,mu,c1,c2,c3456) + t28*Int(ep,mu,c1,c23,c456) + t19*Int(ep,mu,c12,c34,c56) + t207*Int(ep,mu,c2,c3,c1456) + t26*Int(ep,mu,c2,c34,c561) + t208*Int(ep,mu,c3,c4,c1256) + t20*Int(ep,mu,c34,c12,c56) + t29*Int(ep,mu,c5,c6,c1234) + t210*Int(ep,mu,c1,c2,c34,c56) + t25*Int(ep,mu,c2,c3,c4,c156) + t67*Int(ep,mu,c3,c2,c1,c456) + t245*Int(ep,mu,c4,c3,c12,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpmmqmemep_L
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, m, qm, em, ep}, L}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:02:50 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co5 = Complex(0,1); 
SeriesC<T> result = co5*(t9*Int(ep,mu,c12,c3456) + t1*Int(ep,mu,c123,c456) + t2*Int(ep,mu,c56,c1234) + co1*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c1,c2,c3,c456) + co3*Int(ep,mu,c1,c23,c4,c56) + co4*Int(ep,mu,c2,c3,c4,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qppqmpemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, p, qm, p, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:03:28 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa23 = SPA(2,3);
complex<T> spa24 = SPA(2,4);
...
complex<T> co5 = Complex(0,1); 
SeriesC<T> result = co5*(t106*Int(ep,mu,c123,c456) + t27*Int(ep,mu,c23,c1456) + t13*Int(ep,mu,c234,c156) + t92*Int(ep,mu,c34,c1256) + t68*Int(ep,mu,c56,c1234) + t10*Int(ep,mu,c1,c23,c456) + co1*Int(ep,mu,c1,c4,c2356) + t11*Int(ep,mu,c2,c3,c1456) + t12*Int(ep,mu,c2,c34,c561) + t101*Int(ep,mu,c3,c4,c1256) + t9*Int(ep,mu,c4,c563,c12) + t83*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c2,c1,c4,c356) + co3*Int(ep,mu,c3,c12,c4,c56) + co4*Int(ep,mu,c3,c2,c1,c456) + t91*Int(ep,mu,c4,c23,c1,c56) + t54*Int(ep,mu,c4,c3,c2,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qppqmmemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, p, qm, m, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:21:47 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
complex<T> spb12 = SPB(1,2);
...
complex<T> co7 = Complex(0,1); 
SeriesC<T> result = co7*(t329*Int(ep,mu,c123,c456) + t46*Int(ep,mu,c124,c356) + t6*Int(ep,mu,c14,c2356) + t1*Int(ep,mu,c23,c1456) + t120*Int(ep,mu,c234,c156) + t2*Int(ep,mu,c56,c1234) + t26*Int(ep,mu,c1,c2,c3456) + t271*Int(ep,mu,c1,c23,c456) + t28*Int(ep,mu,c1,c4,c2356) + t24*Int(ep,mu,c12,c34,c56) + t14*Int(ep,mu,c14,c23,c56) + t29*Int(ep,mu,c2,c3,c1456) + t128*Int(ep,mu,c2,c34,c561) + t5*Int(ep,mu,c23,c14,c56) + t23*Int(ep,mu,c3,c4,c1256) + co1*Int(ep,mu,c34,c12,c56) + t27*Int(ep,mu,c4,c563,c12) + t31*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c1,c2,c34,c56) + co3*Int(ep,mu,c2,c1,c4,c356) + co4*Int(ep,mu,c3,c2,c1,c456) + t30*Int(ep,mu,c3,c2,c14,c56) + t25*Int(ep,mu,c4,c1,c23,c56) + co5*Int(ep,mu,c4,c3,c12,c56) + co6*Int(ep,mu,c4,c3,c2,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpmqmpemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, qm, p, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:39:53 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa12 = SPA(1,2);
complex<T> spa23 = SPA(2,3);
...
complex<T> co7 = Complex(0,1); 
SeriesC<T> result = co7*(t2*Int(ep,mu,c12,c3456) + t289*Int(ep,mu,c123,c456) + t121*Int(ep,mu,c124,c356) + t46*Int(ep,mu,c234,c156) + t5*Int(ep,mu,c34,c1256) + t1*Int(ep,mu,c56,c1234) + t29*Int(ep,mu,c1,c2,c3456) + t22*Int(ep,mu,c1,c23,c456) + t27*Int(ep,mu,c1,c4,c2356) + t6*Int(ep,mu,c12,c34,c56) + co1*Int(ep,mu,c14,c23,c56) + t30*Int(ep,mu,c2,c3,c1456) + t25*Int(ep,mu,c2,c34,c561) + t28*Int(ep,mu,c23,c14,c56) + t24*Int(ep,mu,c3,c4,c1256) + t13*Int(ep,mu,c34,c12,c56) + t348*Int(ep,mu,c4,c563,c12) + t32*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c1,c2,c3,c456) + t23*Int(ep,mu,c1,c2,c34,c56) + co3*Int(ep,mu,c2,c3,c4,c156) + co4*Int(ep,mu,c3,c2,c14,c56) + co5*Int(ep,mu,c4,c1,c2,c356) + co6*Int(ep,mu,c4,c1,c23,c56) + t324*Int(ep,mu,c4,c3,c12,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpmqmmemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, qm, m, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:40:33 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co5 = Complex(0,1); 
SeriesC<T> result = co5*(t27*Int(ep,mu,c12,c3456) + t99*Int(ep,mu,c123,c456) + t14*Int(ep,mu,c124,c356) + t84*Int(ep,mu,c14,c2356) + t66*Int(ep,mu,c56,c1234) + t12*Int(ep,mu,c1,c23,c456) + t10*Int(ep,mu,c1,c4,c2356) + t13*Int(ep,mu,c2,c3,c1456) + t9*Int(ep,mu,c2,c34,c561) + co1*Int(ep,mu,c3,c4,c1256) + t72*Int(ep,mu,c4,c563,c12) + t83*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c1,c2,c3,c456) + co3*Int(ep,mu,c1,c23,c4,c56) + co4*Int(ep,mu,c2,c3,c4,c156) + t11*Int(ep,mu,c4,c1,c2,c356) + t92*Int(ep,mu,c4,c12,c3,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmppemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, p, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 00:41:22 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
complex<T> spa14 = SPA(1,4);
...
SeriesC<T> result = co4*(t18*Int(ep,mu,c12,c3456) + t2*Int(ep,mu,c123,c456) + t21*Int(ep,mu,c124,c356) + t20*Int(ep,mu,c23,c1456) + t1*Int(ep,mu,c234,c156) + t3*Int(ep,mu,c56,c1234) + t10*Int(ep,mu,c1,c2,c3456) + t14*Int(ep,mu,c1,c23,c456) + co1*Int(ep,mu,c1,c34,c256) + t17*Int(ep,mu,c2,c3,c1456) + t11*Int(ep,mu,c2,c34,c561) + t19*Int(ep,mu,c3,c4,c1256) + t13*Int(ep,mu,c4,c563,c12) + t23*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c2,c1,c4,c356) + co3*Int(ep,mu,c2,c14,c3,c56) + t15*Int(ep,mu,c3,c12,c4,c56) + t74*Int(ep,mu,c3,c2,c1,c456) + t12*Int(ep,mu,c4,c23,c1,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmpmemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, m, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 03:44:56 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb14 = SPB(1,4);
...
complex<T> co1 = Complex(0,1); 
SeriesC<T> result = co1*(t2*Int(ep,mu,c12,c3456) + t159*Int(ep,mu,c123,c456) + t155*Int(ep,mu,c124,c356) + t164*Int(ep,mu,c134,c256) + t4*Int(ep,mu,c14,c2356) + t1*Int(ep,mu,c23,c1456) + t165*Int(ep,mu,c234,c156) + t15*Int(ep,mu,c34,c1256) + t3*Int(ep,mu,c56,c1234) + t726*Int(ep,mu,c1,c2,c3456) + t54*Int(ep,mu,c1,c23,c456) + t59*Int(ep,mu,c1,c34,c256) + t58*Int(ep,mu,c1,c4,c2356) + t22*Int(ep,mu,c12,c34,c56) + t14*Int(ep,mu,c14,c23,c56) + t53*Int(ep,mu,c2,c3,c1456) + t50*Int(ep,mu,c2,c34,c561) + t13*Int(ep,mu,c23,c14,c56) + t56*Int(ep,mu,c3,c4,c1256) + t55*Int(ep,mu,c34,c12,c56) + t49*Int(ep,mu,c4,c563,c12) + t62*Int(ep,mu,c5,c6,c1234) + t757*Int(ep,mu,c1,c2,c34,c56) + t282*Int(ep,mu,c2,c1,c34,c56) + t683*Int(ep,mu,c3,c2,c1,c456) + t756*Int(ep,mu,c3,c2,c14,c56) + t725*Int(ep,mu,c3,c4,c1,c256) + t47*Int(ep,mu,c3,c4,c12,c56) + t48*Int(ep,mu,c4,c1,c2,c356) + t680*Int(ep,mu,c4,c1,c23,c56) + t564*Int(ep,mu,c4,c3,c12,c56) + t166*Int(ep,mu,c4,c3,c2,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmmpemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, p, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:46:36 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa23 = SPA(2,3);
complex<T> spa56 = SPA(5,6);
...
SeriesC<T> result = co9*(t2*Int(ep,mu,c12,c3456) + t91*Int(ep,mu,c123,c456) + t90*Int(ep,mu,c124,c356) + t51*Int(ep,mu,c134,c256) + t60*Int(ep,mu,c234,c156) + t7*Int(ep,mu,c34,c1256) + t1*Int(ep,mu,c56,c1234) + t396*Int(ep,mu,c1,c2,c3456) + t26*Int(ep,mu,c1,c23,c456) + t34*Int(ep,mu,c1,c34,c256) + t92*Int(ep,mu,c1,c4,c2356) + t8*Int(ep,mu,c12,c34,c56) + co1*Int(ep,mu,c14,c23,c56) + t32*Int(ep,mu,c2,c3,c1456) + t29*Int(ep,mu,c2,c34,c561) + co2*Int(ep,mu,c23,c14,c56) + t33*Int(ep,mu,c3,c4,c1256) + t31*Int(ep,mu,c34,c12,c56) + t30*Int(ep,mu,c4,c563,c12) + t36*Int(ep,mu,c5,c6,c1234) + t28*Int(ep,mu,c1,c2,c34,c56) + t441*Int(ep,mu,c2,c1,c34,c56) + co3*Int(ep,mu,c3,c2,c1,c456) + co4*Int(ep,mu,c3,c2,c14,c56) + co5*Int(ep,mu,c3,c4,c1,c256) + t95*Int(ep,mu,c3,c4,c12,c56) + co6*Int(ep,mu,c4,c1,c2,c356) + co7*Int(ep,mu,c4,c1,c23,c56) + t164*Int(ep,mu,c4,c3,c12,c56) + co8*Int(ep,mu,c4,c3,c2,c156));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmmmemep_SLC
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, m, em, ep}, SLC}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:47:32 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb14 = SPB(1,4);
...
complex<T> co4 = Complex(0,1); 
SeriesC<T> result = co4*(t22*Int(ep,mu,c12,c3456) + t23*Int(ep,mu,c123,c456) + t2*Int(ep,mu,c124,c356) + t1*Int(ep,mu,c134,c256) + t21*Int(ep,mu,c14,c2356) + t3*Int(ep,mu,c56,c1234) + t12*Int(ep,mu,c1,c2,c3456) + t17*Int(ep,mu,c1,c23,c456) + t91*Int(ep,mu,c1,c34,c256) + t15*Int(ep,mu,c1,c4,c2356) + t19*Int(ep,mu,c2,c3,c1456) + co1*Int(ep,mu,c2,c34,c561) + t14*Int(ep,mu,c3,c4,c1256) + t16*Int(ep,mu,c4,c563,c12) + t20*Int(ep,mu,c5,c6,c1234) + co2*Int(ep,mu,c1,c2,c3,c456) + co3*Int(ep,mu,c1,c23,c4,c56) + t13*Int(ep,mu,c3,c14,c2,c56) + t73*Int(ep,mu,c4,c1,c2,c356) + t18*Int(ep,mu,c4,c12,c3,c56));  
 return(result);
} 
  
  
template <class T> SeriesC<T> C2q2g2l_qpppqmemep_nf_top
      (const eval_param<T>& ep,
                 const T& mu){
...
template <class T> SeriesC<T> C2q2g2l_qppmqmemep_nf_top
      (const eval_param<T>& ep,
                 const T& mu){
...
template <class T> SeriesC<T> C2q2g2l_qpmpqmemep_nf_top
      (const eval_param<T>& ep,
                 const T& mu){
...
template <class T> SeriesC<T> C2q2g2l_qpmmqmemep_nf_top
      (const eval_param<T>& ep,
                 const T& mu){
...
template <class T> SeriesC<T> C2q2g2l_qpppqmemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, p, p, qm, em, ep}, nf}
...
template <class T> SeriesC<T> C2q2g2l_qppmqmemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, p, m, qm, em, ep}, nf}
...
template <class T> SeriesC<T> C2q2g2l_qpmpqmemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, p, qm, em, ep}, nf}
...
template <class T> SeriesC<T> C2q2g2l_qpmmqmemep_nf
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, m, m, qm, em, ep}, nf}
...
template <class T> SeriesC<T> C2q2g2l_qpqmppemep_VECT
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, p, em, ep}, VECT}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:47:43 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa12 = SPA(1,2);
complex<T> spa25 = SPA(2,5);
...
complex<T> co1 = Complex(0,1); 
SeriesC<T> result = co1*(t8*Int(ep,mu,c12,c3456) + t10*Int(ep,mu,c123,c456) + t9*Int(ep,mu,c124,c356) + t46*Int(ep,mu,c356,c124) + t47*Int(ep,mu,c456,c123) + t11*Int(ep,mu,c56,c1234) + t6*Int(ep,mu,c1,c23,c456) + t19*Int(ep,mu,c2,c3,c1456) + t56*Int(ep,mu,c4,c563,c12) + t21*Int(ep,mu,c5,c6,c1234) + t80*Int(ep,mu,c3,c12,c4,c56) + t7*Int(ep,mu,c4,c12,c3,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmpmemep_VECT
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, m, em, ep}, VECT}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:53:17 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa12 = SPA(1,2);
complex<T> spa24 = SPA(2,4);
...
template <class T> SeriesC<T> C2q2g2l_qpqmmpemep_VECT
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, p, em, ep}, VECT}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:58:34 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spb12 = SPB(1,2);
...
template <class T> SeriesC<T> C2q2g2l_qpqmmmemep_VECT
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, m, em, ep}, VECT}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:58:45 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co1 = Complex(0,1); 
SeriesC<T> result = co1*(t10*Int(ep,mu,c12,c3456) + t8*Int(ep,mu,c123,c456) + t9*Int(ep,mu,c124,c356) + t46*Int(ep,mu,c356,c124) + t47*Int(ep,mu,c456,c123) + t11*Int(ep,mu,c56,c1234) + t6*Int(ep,mu,c1,c23,c456) + t19*Int(ep,mu,c2,c3,c1456) + t56*Int(ep,mu,c4,c563,c12) + t20*Int(ep,mu,c5,c6,c1234) + t7*Int(ep,mu,c3,c12,c4,c56) + t80*Int(ep,mu,c4,c12,c3,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmppemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, p, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 04:58:48 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa12 = SPA(1,2);
complex<T> spa25 = SPA(2,5);
...
SeriesC<T> result = co6*(t36*Int(ep,mu,c12,c3456) + t26*Int(ep,mu,c123,c456) + t5*Int(ep,mu,c124,c356) + t41*Int(ep,mu,c56,c1234) + co1*Int(ep,mu,c1,c23,c456) + co2*Int(ep,mu,c2,c3,c1456) + co3*Int(ep,mu,c4,c563,c12) + co4*Int(ep,mu,c5,c6,c1234) + co5*Int(ep,mu,c4,c12,c3,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmpmemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, m, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:00:29 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co6 = Complex(0,1); 
SeriesC<T> result = co6*(t8*Int(ep,mu,c12,c3456) + t157*Int(ep,mu,c123,c456) + t156*Int(ep,mu,c124,c356) + t10*Int(ep,mu,c34,c1256) + t9*Int(ep,mu,c56,c1234) + t3*Int(ep,mu,c1,c2,c3456) + co1*Int(ep,mu,c1,c23,c456) + t7*Int(ep,mu,c12,c34,c56) + co2*Int(ep,mu,c2,c3,c1456) + t1*Int(ep,mu,c3,c4,c1256) + t2*Int(ep,mu,c34,c12,c56) + co3*Int(ep,mu,c4,c563,c12) + t4*Int(ep,mu,c5,c6,c1234) + co4*Int(ep,mu,c3,c4,c12,c56) + co5*Int(ep,mu,c4,c3,c12,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmmpemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, p, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:12 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co6 = Complex(0,1); 
SeriesC<T> result = co6*(t8*Int(ep,mu,c12,c3456) + t153*Int(ep,mu,c123,c456) + t151*Int(ep,mu,c124,c356) + t9*Int(ep,mu,c34,c1256) + t10*Int(ep,mu,c56,c1234) + t3*Int(ep,mu,c1,c2,c3456) + co1*Int(ep,mu,c1,c23,c456) + t7*Int(ep,mu,c12,c34,c56) + co2*Int(ep,mu,c2,c3,c1456) + t1*Int(ep,mu,c3,c4,c1256) + t2*Int(ep,mu,c34,c12,c56) + co3*Int(ep,mu,c4,c563,c12) + t4*Int(ep,mu,c5,c6,c1234) + co4*Int(ep,mu,c3,c4,c12,c56) + co5*Int(ep,mu,c4,c3,c12,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmmmemep_AX
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, m, em, ep}, AX}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:15 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa56 = SPA(5,6);
complex<T> spb12 = SPB(1,2);
...
complex<T> co6 = Complex(0,1); 
SeriesC<T> result = co6*(t35*Int(ep,mu,c12,c3456) + t27*Int(ep,mu,c123,c456) + t39*Int(ep,mu,c124,c356) + t4*Int(ep,mu,c56,c1234) + co1*Int(ep,mu,c1,c23,c456) + co2*Int(ep,mu,c2,c3,c1456) + co3*Int(ep,mu,c4,c563,c12) + co4*Int(ep,mu,c5,c6,c1234) + co5*Int(ep,mu,c3,c12,c4,c56));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmppemep_AXSL
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, p, em, ep}, AXSL}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:16 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
complex<T> spa23 = SPA(2,3);
...
SeriesC<T> result = co3*(co1*Int(ep,mu,c123,c456) + co2*Int(ep,mu,c124,c356) + t3*Int(ep,mu,c56,c1234));  
 return(result);
} 
...
template <class T> SeriesC<T> C2q2g2l_qpqmpmemep_AXSL
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, p, m, em, ep}, AXSL}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:18 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa13 = SPA(1,3);
complex<T> spa23 = SPA(2,3);
...
template <class T> SeriesC<T> C2q2g2l_qpqmmpemep_AXSL
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, p, em, ep}, AXSL}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:19 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spb13 = SPB(1,3);
complex<T> spa25 = SPA(2,5);
...
template <class T> SeriesC<T> C2q2g2l_qpqmmmemep_AXSL
      (const eval_param<T>& ep,
                 const T& mu){
//{{qp, qm, m, m, em, ep}, AXSL}
 ...
 // #define TimeStamp "Tue 18 Nov 2008 05:02:20 on n302"
 // #define Options "extract CSEs: True, shake: True {-2, -5}, simplifyFirst: False"
#define Complex complex<T>
complex<T> spa45 = SPA(4,5);
complex<T> spb13 = SPB(1,3);
...
#define _CASE_qpppqmemep_L case 44408 : \
          return &C2q2g2l_44408_L
#define _CASE_qppmqmemep_L case 44300 : \
          return &C2q2g2l_44300_L
#define _CASE_qpmpqmemep_L case 44390 : \
          return &C2q2g2l_44390_L
#define _CASE_qpmmqmemep_L case 44282 : \
          return &C2q2g2l_44282_L
#define _CASE_qppqmpemep_SLC case 44768 : \
          return &C2q2g2l_44768_SLC
#define _CASE_qppqmmemep_SLC case 44120 : \
          return &C2q2g2l_44120_SLC
#define _CASE_qpmqmpemep_SLC case 44750 : \
          return &C2q2g2l_44750_SLC
#define _CASE_qpmqmmemep_SLC case 44102 : \
          return &C2q2g2l_44102_SLC
#define _CASE_qpqmppemep_SLC case 44828 : \
          return &C2q2g2l_44828_SLC
#define _CASE_qpqmpmemep_SLC case 44180 : \
          return &C2q2g2l_44180_SLC
#define _CASE_qpqmmpemep_SLC case 44720 : \
          return &C2q2g2l_44720_SLC
#define _CASE_qpqmmmemep_SLC case 44072 : \
          return &C2q2g2l_44072_SLC
#define _CASE_qpppqmemep_nf_top case 44408 : \
          return &C2q2g2l_44408_nf_top
#define _CASE_qppmqmemep_nf_top case 44300 : \
          return &C2q2g2l_44300_nf_top
#define _CASE_qpmpqmemep_nf_top case 44390 : \
          return &C2q2g2l_44390_nf_top
#define _CASE_qpmmqmemep_nf_top case 44282 : \
          return &C2q2g2l_44282_nf_top
#define _CASE_qpppqmemep_nf case 44408 : \
          return &C2q2g2l_44408_nf
#define _CASE_qppmqmemep_nf case 44300 : \
          return &C2q2g2l_44300_nf
#define _CASE_qpmpqmemep_nf case 44390 : \
          return &C2q2g2l_44390_nf
#define _CASE_qpmmqmemep_nf case 44282 : \
          return &C2q2g2l_44282_nf
#define _CASE_qpqmppemep_VECT case 44828 : \
          return &C2q2g2l_44828_VECT
#define _CASE_qpqmpmemep_VECT case 44180 : \
          return &C2q2g2l_44180_VECT
#define _CASE_qpqmmpemep_VECT case 44720 : \
          return &C2q2g2l_44720_VECT
#define _CASE_qpqmmmemep_VECT case 44072 : \
          return &C2q2g2l_44072_VECT
#define _CASE_qpqmppemep_AX case 44828 : \
          return &C2q2g2l_44828_AX
#define _CASE_qpqmpmemep_AX case 44180 : \
          return &C2q2g2l_44180_AX
#define _CASE_qpqmmpemep_AX case 44720 : \
          return &C2q2g2l_44720_AX
#define _CASE_qpqmmmemep_AX case 44072 : \
          return &C2q2g2l_44072_AX
#define _CASE_qpqmppemep_AXSL case 44828 : \
          return &C2q2g2l_44828_AXSL
#define _CASE_qpqmpmemep_AXSL case 44180 : \
          return &C2q2g2l_44180_AXSL
#define _CASE_qpqmmpemep_AXSL case 44720 : \
          return &C2q2g2l_44720_AXSL
#define _CASE_qpqmmmemep_AXSL case 44072 : \
          return &C2q2g2l_44072_AXSL
 
 
 // *************** function definitions using macros ************* 
 
template <class T> SeriesC<T> _C_qpppqmemep_L(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpppqmemep_L(ep,mu);}
 
template <class T> SeriesC<T> _C_qppmqmemep_L(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qppmqmemep_L(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmpqmemep_L(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmpqmemep_L(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmmqmemep_L(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmmqmemep_L(ep,mu);}
 
template <class T> SeriesC<T> _C_qppqmpemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qppqmpemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qppqmmemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qppqmmemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmqmpemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmqmpemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmqmmemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmqmmemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmppemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmppemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmpmemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmpmemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmpemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmpemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmmemep_SLC(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmmemep_SLC(ep,mu);}
 
template <class T> SeriesC<T> _C_qpppqmemep_nf_top(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpppqmemep_nf_top(ep,mu);}
 
template <class T> SeriesC<T> _C_qppmqmemep_nf_top(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qppmqmemep_nf_top(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmpqmemep_nf_top(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmpqmemep_nf_top(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmmqmemep_nf_top(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmmqmemep_nf_top(ep,mu);}
 

template <class T> SeriesC<T> _C_qpppqmemep_nf(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpppqmemep_nf(ep,mu);}
 
template <class T> SeriesC<T> _C_qppmqmemep_nf(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qppmqmemep_nf(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmpqmemep_nf(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmpqmemep_nf(ep,mu);}
 
template <class T> SeriesC<T> _C_qpmmqmemep_nf(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpmmqmemep_nf(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmppemep_VECT(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmppemep_VECT(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmpmemep_VECT(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmpmemep_VECT(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmpemep_VECT(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmpemep_VECT(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmmemep_VECT(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmmemep_VECT(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmppemep_AX(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmppemep_AX(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmpmemep_AX(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmpmemep_AX(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmpemep_AX(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmpemep_AX(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmmemep_AX(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmmemep_AX(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmppemep_AXSL(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmppemep_AXSL(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmpmemep_AXSL(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmpmemep_AXSL(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmpemep_AXSL(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmpemep_AXSL(ep,mu);}
 
template <class T> SeriesC<T> _C_qpqmmmemep_AXSL(
        const eval_param<T>& ep, const T& mu){
          return C2q2g2l_qpqmmmemep_AXSL(ep,mu);}
...
template <class T> SeriesC<T> ( *C2q2g2l_AXSL_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template <class T> SeriesC<T> ( *C2q2g2l_SLC_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template <class T> SeriesC<T> ( *C2q2g2l_VECT_Ptr_eval( int hc))
     (const eval_param<T>&, const T&) {
       switch (hc) {
...
template SeriesC<R> ( *C2q2g2l_AXSL_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2g2l_AXSL_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2g2l_AXSL_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);
...
template SeriesC<R> ( *C2q2g2l_SLC_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2g2l_SLC_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2g2l_SLC_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);


template SeriesC<R> ( *C2q2g2l_VECT_Ptr_eval(int hc))
             (const eval_param<R>&, const R&);
template SeriesC<RHP> ( *C2q2g2l_VECT_Ptr_eval(int hc))
             (const eval_param<RHP>&, const RHP&);
template SeriesC<RVHP> ( *C2q2g2l_VECT_Ptr_eval(int hc))
             (const eval_param<RVHP>&, const RVHP&);
