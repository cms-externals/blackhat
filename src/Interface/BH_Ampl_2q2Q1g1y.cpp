...
//expected indices:
// q g Gb G qb l lb
partial_amplitude_cached* A_loop_2q_2Q_1g_1y_6_1(process pro,vector<int> & ind, int n_s, int n_f, int n_c,bool up_down_quark,int photonZW, const ph_type e_ph_type, int color,QCDorder lo_or_nlo=nlo){
...
//a-type ~ sub_leading_color contributions:
	...
	process pro_25341=process(h2,h5,h3,h4,h1,h6);
	...
	process pro_23415=process(h2,h3,h4,h1,h5,h6);
	...
	process pro_24315=process(h2,hp4,hp3,h1,h5,h6);
	...
	process pro_23541=process(h2,h3,h5,h4,h1,h6);
	...
	process pro_24531=process(h2,hp4,h5,hp3,h1,h6);
	...
	process pro_23451=process(h2,h3,h4,h5,h1,h6);
	...
	process pro_24351=process(h2,hp4,hp3,h5,h1,h6);
	...
	process pro_25431=process(h2,h5,hp4,hp3,h1,h6);
...
//b-type ~ sub_leading_color contributions:
	...
	process pro_21435=process(h2,h1,h4,h3,h5,h6);
...
//expected indices:
// q Gb G g qb l lb
partial_amplitude_cached* A_loop_2q_2Q_1g_1y_6_3(process pro,vector<int> & ind, int n_s, int n_f, int n_c,bool up_down_quark,int photonZW, const ph_type e_ph_type, int color,QCDorder lo_or_nlo=nlo){
	partial_amplitude_cached* PA=new partial_amplitude_cached(lo_or_nlo);
// equivalent to B1
	int i1=ind.at(0);
	int i2=ind.at(1);
...
//b-type ~ sub_leading_color contributions:
	...
	process pro_21543=process(h2,h1,h5,h4,h3,h6);
...
//expected indices:
// q Gb g G qb l lb
partial_amplitude_cached* A_loop_2q_2Q_1g_1y_6_2(process pro,vector<int> & ind, int n_s, int n_f, int n_c,bool up_down_quark,int photonZW, const ph_type e_ph_type, int color,QCDorder lo_or_nlo=nlo){
	partial_amplitude_cached* PA=new partial_amplitude_cached(lo_or_nlo);
// equivalent to B4
	int i1=ind.at(0);
	int i2=ind.at(1);
...
//b-type ~ sub_leading_color contributions:
	...
	process pro_25143=process(h2,h5,h1,h4,h3,h6);
	...
	process pro_21453=process(h2,h1,h4,h5,h3,h6);
...
//expected indices:
// q Gb G qb g l lb
partial_amplitude_cached* A_loop_2q_2Q_1g_1y_6_4(process pro,vector<int> & ind, int n_s, int n_f, int n_c,bool up_down_quark,int photonZW, const ph_type e_ph_type,int color,QCDorder lo_or_nlo=nlo){
	partial_amplitude_cached* PA=new partial_amplitude_cached(lo_or_nlo);
// equivalent to B2
	int i1=ind.at(0);
	int i2=ind.at(1);
...
Squared_ME* A_loop_2q_2Q_1g_1y_M2(process pro, vector<int> & ind, int n_s, int n_f, int n_c, int photonZW, const ph_type e_ph_type,int case4q,int color, int tree_color,QCDorder lo_or_nlo=nlo){
...
process pro_15234=process(h1,h5,h2,h3,h4,h6);
...
process pro_12534=process(h1,h2,h5,h3,h4,h6);
...
process pro_12354=process(h1,h2,h3,h5,h4,h6);
...
process pro_35412=process(hf3,h5,hf4,hf1,hf2,h6);
...
process pro_34512=process(hf3,hf4,h5,hf1,hf2,h6);
...
process pro_34152=process(hf3,hf4,hf1,h5,hf2,h6);
...
process pro_34125=process(hf3,hf4,hf1,hf2,h5,h6);
...
process pro_35214=process(hpf3,hp5,hpf2,hpf1,hpf4,hp6);
...
process pro_32514=process(hpf3,hpf2,hp5,hpf1,hpf4,hp6);
...
process pro_32154=process(hpf3,hpf2,hpf1,hp5,hpf4,hp6);
...
process pro_32145=process(hpf3,hpf2,hpf1,hpf4,hp5,hp6);
...
process pro_15432=process(hp1,hp5,hp4,hp3,hp2,hp6);
...
process pro_14532=process(hp1,hp4,hp5,hp3,hp2,hp6);
...
process pro_14352=process(hp1,hp4,hp3,hp5,hp2,hp6);
...
process pro_14325=process(hp1,hp4,hp3,hp2,hp5,hp6);
...
//--------------------- propagator correction
	prop_hel_fn _prop_hel_fn_up_1(0,photonZW,0,i6,i6,_ph_type_1);
	prop_hel_fn _prop_hel_fn_up_3(0,photonZW,0,i6,i6,_ph_type_3);
	prop_hel_fn _prop_hel_fn_down_1(1,photonZW,0,i6,i6,_ph_type_1);
	prop_hel_fn _prop_hel_fn_down_3(1,photonZW,0,i6,i6,_ph_type_3);
//-------------------------------------------
...
if(color!=1){
		L1_15234_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15234,ind_15234,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L3_12354_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_12354,ind_12354,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L1_35412_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35412,ind_35412,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L3_34152_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_34152,ind_34152,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
}
		L1_color_15234_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15234,ind_15234,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_12354_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_12354,ind_12354,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L1_color_35412_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35412,ind_35412,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_34152_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_34152,ind_34152,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));

if(color!=1){
		L2_12534_up=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_12534,ind_12534,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L4_12345_up=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_12345,ind_12345,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L2_34512_up=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_34512,ind_34512,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L4_34125_up=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_34125,ind_34125,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
}
...
if(color!=1){
		L1_15432_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15432,ind_15432,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L3_14352_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_14352,ind_14352,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L1_35214_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35214,ind_35214,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L3_32154_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_32154,ind_32154,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
}
		L1_color_15432_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15432,ind_15432,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_14352_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_14352,ind_14352,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L1_color_35214_up=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35214,ind_35214,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_32154_up=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_32154,ind_32154,n_s,n_f,n_c,0,photonZW,e_ph_type,color, lo_or_nlo));


if(color!=1){
		L2_14532_up=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_14532,ind_14532,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L4_14325_up=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_14325,ind_14325,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L2_32514_up=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_32514,ind_32514,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
		L4_32145_up=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_32145,ind_32145,n_s,n_f,n_c,0,photonZW,e_ph_type,0, lo_or_nlo));
}
...
if(color!=1){
		L1_15234_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15234,ind_15234,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L3_12354_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_12354,ind_12354,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L1_35412_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35412,ind_35412,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L3_34152_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_34152,ind_34152,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
}
		L1_color_15234_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15234,ind_15234,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_12354_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_12354,ind_12354,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L1_color_35412_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35412,ind_35412,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_34152_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_34152,ind_34152,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
if(color!=1){
		L2_12534_down=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_12534,ind_12534,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L4_12345_down=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_12345,ind_12345,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L2_34512_down=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_34512,ind_34512,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L4_34125_down=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_34125,ind_34125,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
}
...
if(color!=1){
		L1_15432_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15432,ind_15432,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L3_14352_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_14352,ind_14352,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L1_35214_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35214,ind_35214,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L3_32154_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_32154,ind_32154,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
}
		L1_color_15432_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_15432,ind_15432,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_14352_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_14352,ind_14352,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L1_color_35214_down=SM->add(A_loop_2q_2Q_1g_1y_6_1(pro_35214,ind_35214,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
		L3_color_32154_down=SM->add(A_loop_2q_2Q_1g_1y_6_3(pro_32154,ind_32154,n_s,n_f,n_c,1,photonZW,e_ph_type,color, lo_or_nlo));
if(color!=1){
		L2_14532_down=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_14532,ind_14532,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L4_14325_down=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_14325,ind_14325,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L2_32514_down=SM->add(A_loop_2q_2Q_1g_1y_6_2(pro_32514,ind_32514,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
		L4_32145_down=SM->add(A_loop_2q_2Q_1g_1y_6_4(pro_32145,ind_32145,n_s,n_f,n_c,1,photonZW,e_ph_type,0, lo_or_nlo));
}
	};
...
multi_precision_fraction ext_tree(2*n_c*(n_c*n_c-1),1);
...
Virtual_SME* vsme_2q2Q1g1y(std::vector<int> indext,int ns,int nf,int nc,int photonZW, int case4q,int color, int tree_color,QCDorder lo_or_nlo=nlo){
...
//cout<< "start construction:"<< endl;
	...
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbp,qm,qbm,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
if(photonZW!=3){
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qp,qbm,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
}	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qm,qbp,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));

	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbm,qp,qbp,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qm,qbp,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qp,qbm,m,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
if(photonZW!=3){
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbp,qm,qbm,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qp,qbm,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qm,qbp,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));

	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbm,qp,qbp,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qm,qbp,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qp,qbm,m,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
}
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbp,qm,qbm,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
if(photonZW!=3){
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qp,qbm,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
}	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qm,qbp,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));

	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbm,qp,qbp,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qm,qbp,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qp,qbm,p,yp),ind,ns,nf,nc,photonZW,lm,case4q,color,tree_color,lo_or_nlo));
if(photonZW!=3){
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbp,qm,qbm,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qp,qbm,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qp,qbm,qm,qbp,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));

	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbm,qp,qbp,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qm,qbp,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
	VSM->add(A_loop_2q_2Q_1g_1y_M2(process(qm,qbp,qp,qbm,p,ym),ind,ns,nf,nc,photonZW,lp,case4q,color,tree_color,lo_or_nlo));
}
after=clock();
...
BH_Ampl_2q2Q1g1y::BH_Ampl_2q2Q1g1y(int photonZW,int case4q,int color,int tree_color,const std::vector<int>& mom_assignment,QCDorder lo_or_nlo,BH_interface_impl* bhi):
	BH_Ampl_impl(
			vsme_2q2Q1g1y(mom_assignment,
				0,
...
double BH_Ampl_2q2Q1g1y::getScaleVariationCoefficient(int logMuOrder){
