...
#define WRITE_TARGETS 0    //[0,1] ...  [write to, compare with] targets
...
#include "../../test/PStest/STUDYNAME/collectPS.log"
	...
	cout<<"nubr of subprocesses: "<<me2.size()<<endl;
	cout <<"======================="<<endl;


	// running on PS points
        cout<<setprecision(16);
        const char * MOMENTAfile;
	MOMENTAfile="../../test/PStest/STUDYNAME/PSpoints.dat";
	size_t multiplicity(processes[0].size());

        const char * TARGETfile;
	TARGETfile="../../test/PStest/STUDYNAME/target.dat";


	ifstream momenta_file;
	momenta_file.open(MOMENTAfile);

#if WRITE_TARGETS==1
	ifstream targets_file;
	targets_file.open(TARGETfile);
#else
