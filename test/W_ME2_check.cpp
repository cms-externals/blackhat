...
res_me2.push_back(C(-5.614787651,0));
res_me2.push_back(C(-7.696784963,0));
res_me2.push_back(C(-2.666666667,0));
res_me2_born=C(1.162251445e-07,0);
...
#if write_C
	cout<<"res_me2.push_back(C"<<me2_finite<<");"<<endl;
	cout<<"res_me2.push_back(C"<<me2_single_pole<<");"<<endl;
	cout<<"res_me2.push_back(C"<<me2_double_pole<<");"<<endl;
