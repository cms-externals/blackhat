...
static char sccsid_FeynDiagram[] = "$Id: fd.C,v 1.3 2009/01/26 17:55:25 maitreda Exp $";
...
//	cerr << "Version $Revision: 1.3 $   $Date: 2009/01/26 17:55:25 $\n";
//#ifdef TESTVERSION
...
//	cerr << "\n";
	...
	out << "%!\n";
	out << "%%Creator: FeynDiagram $Revision: 1.3 $  by Bill Dimm\n";
	bb = total_bbox();
